...
EventLoop = (function(superClass) {
  extend(EventLoop, superClass);
      ...
      return function(resolve, reject) {
        ...
        work = new Promise(function(resolve, reject) {
          ...
          ontick = function(next) {
            var completed, error, error1, waitFor;
            if (next >= timeoutOn) {
              resolve();
  ...
  EventLoop.prototype.run = function() {
    ...
    setImmediate((function(_this) {
      return function() {
        var error, error1, error2, fn, nextTick;
        _this.running = false;
        if (!_this.active) {
          _this.emit("done");
          return;
...
EventQueue = (function() {
  ...
  EventQueue.prototype.destroy = function() {
    var eventSource, expecting, i, j, k, len, len1, len2, ref, ref1, ref2, timer;
    ref = this.timers;
  ...
  EventQueue.prototype.next = function() {
    var frame, frameNext, i, j, len, len1, next, ref, ref1, timer;
    next = Infinity;
    ref = this.timers;
    for (i = 0, len = ref.length; i < len; i++) {
      timer = ref[i];
...
Timeout = (function() {
  function Timeout(queue, fn1, delay1, remove1) {
    var fire;
    this.queue = queue;
    this.fn = fn1;
    this.delay = delay1;
...
Interval = (function() {
  function Interval(queue, fn1, interval1, remove1) {
