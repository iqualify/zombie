...
Entry = (function() {
  function Entry(window1, url, pushState1) {
    this.window = window1;
    this.pushState = pushState1;
...
History = (function() {
  function History(browser1, focus1) {
  ...
  History.prototype.__defineGetter__("url", function() {
    var ref;
    return (ref = this.current) != null ? ref.url : void 0;
  });
...
hashChange = function(entry, url) {
  var aBase, aHash, bBase, bHash, ref, ref1;
  if (!entry) {
    return false;
  }
  ref = url.split("#"), aBase = ref[0], aHash = ref[1];
  ref1 = entry.url.split("#"), bBase = ref1[0], bHash = ref1[1];
  return aBase === bBase && aHash !== bHash;
};

createLocation = function(history) {
  var browser, fn, j, len, location, prop, ref, url;
  ...
  ref = ["hash", "host", "pathname", "port", "protocol", "search"];
  fn = (function(_this) {
