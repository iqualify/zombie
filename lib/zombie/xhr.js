...
XMLHttpRequest = (function(superClass) {
  ...
  XMLHttpRequest.prototype.send = function(data) {
    ...
    request = this._pending;
    (base = request.headers)["content-type"] || (base["content-type"] = "text/plain");
    request.body = data;
    request.timeout = this.timeout;
    this._window._eventQueue.http(request.method, request.url, request, (function(_this) {
      return function(error, response) {
        var allowedOrigin, ref, wrappedError;
        ...
        _this.responseText = ((ref = response.body) != null ? ref.toString() : void 0) || "";
